...
class UsersWebServerImplTest {
    ...
    static void setUp() throws Exception {
        ...
        DBService<Client> dbServiceClient = mock(DbServiceClientImpl.class);
        ...
        webServer = new UsersWebServerWithFilterBasedSecurity(WEB_SERVER_PORT, userAuthService, userDao, dbServiceClient, gson, templateProcessor);
        webServer.start();
    }
